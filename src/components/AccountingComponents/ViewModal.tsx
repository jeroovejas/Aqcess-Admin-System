                        ...
                        <div className="border-0  relative text-black w-full h-full outline-none focus:outline-none  px-8 py-8">
                            ...
                            <div className="w-full my-6 ">
                                <div className="flex py-4 border-b-[3px] border-slate-100 ">
                                    <p className='font-bold w-1/3'> {t('ACCOUNTNG.viewModal.invoice.label1')}</p>
                                    <p className='font-medium w-2/3'>{payment.invoiceId || "N/A"}</p>
                                </div>
                                <div className="flex py-4 border-b-[3px] border-slate-100 ">
                                    <p className='font-bold w-1/3'>{t('ACCOUNTNG.viewModal.invoice.label2')}</p>
                                    <p className='font-medium w-2/3'>{payment.residentName || "N/A"}</p>

                                </div>
                                <div className="flex py-4 border-b-[3px] border-slate-100 ">
                                    <p className='font-bold w-1/3'>{t('ACCOUNTNG.viewModal.invoice.label3')}</p>
                                    <p className='font-medium w-2/3'> {payment.type ? toTitleCase(payment.type) : "N/A"}</p>
                                </div>
                                <div className="flex py-4 border-b-[3px] border-slate-100 ">
                                    <p className='font-bold w-1/3'>{t('ACCOUNTNG.viewModal.invoice.label4')}</p>
                                    <p className='font-medium w-2/3'> {payment.adminStatus || "N/A"}</p>

                                </div>
                                {payment.attachment &&
                                    <div className=" py-4 ">
                                        <div className="flex justify-between">
                                            <div className='font-bold '>{t('ACCOUNTNG.viewModal.invoice.label5')}</div>
                            ...
                            <div className="w-full my-6 ">
                                <div className="flex py-4 border-b-[3px] border-slate-100 ">
                                    <p className='font-bold w-1/3'> {t('ACCOUNTNG.viewModal.product.label1')}</p>
                                    <p className='font-medium w-2/3'>{payment.productTitle || "N/A"}</p>
                                </div>
                                <div className="flex py-4 border-b-[3px] border-slate-100 ">
                                    <p className='font-bold w-1/3'>{t('ACCOUNTNG.viewModal.product.label2')}</p>
                                    <p className='font-medium w-2/3'>{payment.productPrice || "N/A"}</p>

                                </div>
                                <div className="flex py-4 border-b-[3px] border-slate-100 ">
                                    <p className='font-bold w-1/3'>{t('ACCOUNTNG.viewModal.product.label3')}</p>
                                    <p className='font-medium w-2/3'> {payment.productDesc || "N/A"}</p>
                                </div>
                                <div className="flex py-4 border-b-[3px] border-slate-100 ">
                                    <p className='font-bold w-1/3'>{t('ACCOUNTNG.viewModal.product.label4')}</p>
                                    <p className='font-medium w-2/3'> {payment.productType || "N/A"}</p>
                                </div>
                                <div className="flex py-4 border-b-[3px] border-slate-100 ">
                                    <p className='font-bold w-1/3'>{t('ACCOUNTNG.viewModal.product.label5')}</p>
                            ...
                            <div className="w-full my-6 ">
                                <div className="flex py-4 border-b-[3px] border-slate-100 ">
                                    <p className='font-bold w-1/3'> {t('ACCOUNTNG.viewModal.expenses.label1')}</p>
                                    <p className='font-medium w-2/3'>{payment.expenseUser || "N/A"}</p>
                                </div>
                                <div className="flex py-4 border-b-[3px] border-slate-100 ">
                                    <p className='font-bold w-1/3'>{t('ACCOUNTNG.viewModal.expenses.label2')}</p>
                                    <p className='font-medium w-2/3'>{payment.expenseAmount || "N/A"}</p>

                                </div>
                                <div className="flex py-4 border-b-[3px] border-slate-100 ">
                                    <p className='font-bold w-1/3'>{t('ACCOUNTNG.viewModal.expenses.label3')}</p>
                                    <p className='font-medium w-2/3'> {payment.expenseDesc || "N/A"}</p>
                                </div>
                                <div className="flex py-4 border-b-[3px] border-slate-100 ">
                                    <p className='font-bold w-1/3'>{t('ACCOUNTNG.viewModal.expenses.label4')}</p>
                                    <p className='font-medium w-2/3'> {payment.expenseDate || "N/A"}</p>

                                </div>
                                {payment.expenseAttachment &&
                                    <div className=" py-4 ">
                                        <div className="flex justify-between">
                                            <div className='font-bold '>{t('ACCOUNTNG.viewModal.expenses.label5')}</div>
                                            <div className="relative group flex items-center me-">
                                                <button onClick={() => downloadBase64Image(payment.expenseAttachmentBase64)} className="p-2">
                                                    <LuDownload className="text-lg" />
                                                </button>
                                        ...
                                        <img src={payment.expenseAttachment} className='w-full mt-3 h-[250px] object-cover rounded-lg' alt='Attachment' />
