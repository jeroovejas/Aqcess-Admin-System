...
//                             <button className="bg-transparent border-0 text-[20px] font-bold text-black " onClick={() => dispatch(toggleEditProduct())}>
//                                 x
//                             </button>
//                         </div>
...
//                                     </label>
//                                     <textarea value={formState.description} name='description' className="block w-full h-48 bg-gray-200 border border-[#DDDDDD] rounded-xl py-3 px-4 overflow-auto resize-none mb-3 leading-tight focus:outline-none focus:bg-white" placeholder={t('PRODUCT.button1Modal.lable2')} onChange={handleChange} required />
//                                 </div>
...
//                                             </label>
//                                             <input className="appearance-none block w-full bg-gray-200 border border-[#DDDDDD] rounded-xl py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" type="text" name='year' readOnly value={productData.productDetail[0]?.year || ''} />
//                                         </div>
//                                         <div className="w-full">
...
//                                             </label>
//                                             {/* <input className="appearance-none block w-full bg-gray-200 border border-[#DDDDDD] rounded-xl py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white" type="text" name='month' readOnly value={productData.productDetail[0].month} /> */}
//                                             <input
//                                                 className="appearance-none block w-full bg-gray-200 border border-[#DDDDDD] rounded-xl py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white"
//                                                 type="text"
//                                                 name="month"
//                                                 readOnly
//                                                 value={productData?.productDetail?.map((item: any) => item.month).join(', ') || ''}
//                                             />
//                                         </div>
//                                     </>
//                                 )}
