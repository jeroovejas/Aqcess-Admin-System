...
import { toggleExportModal } from "@/store/Slices/ExpenseSlice"
...
const ExportModal: React.FC<any> = () => {
    ...
    const handleExport = async () => {
        ...
        try {
            ...
            console.error('Unexpected error during expense expense export:', err.message);
        } finally {
            setLoading(false)
        }
    };
                    ...
                    <div className="flex justify-center items-center overflow-x-hidden overflow-y-auto fixed inset-0 z-50 outline-none focus:outline-none">
                        <div className="relative w-[calc(100vw-20px)] md:w-auto my-6">
                            <div className="border-0 rounded-lg shadow-lg relative text-black w-full bg-white outline-none focus:outline-none  px-8 py-8">
                                ...
                                <h3 className="text-3xl font-semibold mt-8">{t('EXPENSE.exportModal.title')}</h3>
