...
const PresetContainer = <TPreset extends Preset, TValue>({
  ...
  return (
    ...
    {/* <ul role="list" className="flex items-start gap-x-2 sm:flex-col text-black font-bold"> */}
        ...
        return (
          <li key={index} className="sm:w-full sm:py-px ">
            <button
              ...
              className={cx(
                // base
                "text-black relative w-full overflow-hidden text-ellipsis whitespace-nowrap rounded border px-2.5 py-1.5 text-left text-base shadow-sm outline-none transition-all sm:border-none sm:py-2 sm:text-sm sm:shadow-none ",
                // text color
        ...
        <div className="flex  font-bold">
          <div className="flex flex-col sm:flex-row sm:items-start">
            {presets && presets.length > 0 && (
              ...
              >
                <div className="absolute px-2 pr-2 sm:inset-0 sm:left-0 sm:py-2 text-black font-bold">
                  <PresetContainer
                    currentValue={date}
                    presets={presets}
...
const RangeDatePicker = ({
  ...
  return (
    <PopoverPrimitives.Root open={open} onOpenChange={onOpenChange}>
      ...
      <CalendarPopover align={align}>
        <div className="flex">
          <div className="flex flex-col overflow-x-scroll sm:flex-row sm:items-start text-black font-bold">
            {presets && presets.length > 0 && (
              <div
                className={cx(
            ...
            <div className="overflow-x-scroll">
              ...
              <div className="border-t border-gray-200 p-3 sm:flex sm:items-center sm:justify-between dark:border-gray-800">
                ...
                <div className="mt-2 flex items-center gap-x-2 sm:mt-0 text-black font-bold">
                  <Button
                    variant="secondary"
                    className="h-8 w-full sm:w-fit text-black font-bold"
                    type="button"
                    onClick={onCancel}
                  >
                    {translations?.cancel ?? "Cancel"}
                  ...
                  <Button
                    variant="primary"
                    className="h-8 w-full sm:w-fit bg-slate-900 font-bold"
                    type="button"
                    onClick={onApply}
                  >
                    {translations?.apply ?? "Apply"}
