  ...
  return (
    <>
      {verified ? (
        <>
          <DefaultLayout >
            <Breadcrumb pageName={t('SECURITY.title')} />
            <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-3 2xl:gap-7.5 mb-5">
              <CardDataStats title={t('SECURITY.card1')} total={`${securityGuardDetails.totalSecurityGuards}`} rate="">
              </CardDataStats>
              <CardDataStats title={t('SECURITY.card2')} total={`${securityGuardDetails.activeSecurityGuards}`} rate="">
              </CardDataStats>
            </div>
