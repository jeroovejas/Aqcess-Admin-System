    ...
    <>
      <DefaultLayout>
        ...
        <div className="mb-4 flex justify-between">
          ...
          <div className="flex">
            <div className="">
              <button type="button" onClick={toggleExportModal} className="text-gray-900 bg-white border border-gray-300 hover:bg-gray-100 font-medium rounded-lg text-sm px-6 py-3 ms-4 mb-2 dark:text-white dark:hover:bg-gray-700 flex items-center mr-4">
                <TfiExport className="mr-2 text-base" />Export list
              </button>
            </div>
            <div className="">
              <button type="button" onClick={toggleAddModal} className="text-white bg-[#24292F] hover:bg-[#24292F]/90 focus:ring-4 focus:outline-none focus:ring-[#24292F]/50 font-medium rounded-lg text-sm px-6 py-3 text-center inline-flex items-center dark:focus:ring-gray-500 dark:hover:bg-[#050708]/30 mb-2">
        ...
        {(exportModal || addModal) && <div className="absolute top-0 left-0 w-full h-full bg-black opacity-50">
        </div>}
        <ExportModal exportModal={exportModal} toggleExportModal={toggleExportModal} />
        <AddModal addModal={addModal} toggleAddModal={toggleAddModal} />
      </DefaultLayout>
    </>
  );
};
