    ...
    <>
      <DefaultLayout>
        ...
        <div className="grid grid-cols-1 gap-4 md:grid-cols-2 md:gap-6 xl:grid-cols-3 2xl:gap-7.5 mb-5">
          ...
          <CardDataStats title="Payments this month" total="$1,000" rate="">
            <svg
          ...
          <CardDataStats title="Over payments" total="$200" rate="">
            <svg
              className="fill-primary dark:fill-white"
              width="20"
              height="22"
          ...
          <CardDataStats title="Paid in time" total="95%" rate="">
            <svg
              className="fill-primary dark:fill-white"
              width="22"
              height="22"
        ...
        <div className="mb-4 flex justify-between">
          <div className="flex">
            <div className="relative">
              ...
              <input type="search" id="default-search" className="block w-80 p-3 ps-10 text-sm text-gray-900 border border-gray-200 rounded-lg  dark:placeholder-gray-400 dark:text-white" placeholder="Search by resident or invoice ID" required />
            </div>
