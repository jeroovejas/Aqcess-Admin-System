...
export const metadata: Metadata = {
  title: "Closed Gate Communities | Reset Link",
  description: "Closed Gate Communities Reset Link Page",
  // other metadata
};
          ...
          <div className="bg-white sm:mx-20 mx-28 2xsm:mx-10 3xsm:mx-4 4xsm:mx-6 mt-16 rounded-md">
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <div className="mt-4 mb-6">
                <p>We've just sent a password reset link to the email address associated. Check Your inbox for further instructions.</p>
              </div>
              <form>
                <div className="mb-16">
                  <input
