...
export const metadata: Metadata = {
  title: "Closed Gate Communities | Verify Email",
  description: "Closed Gate Communities Verify Email Page",
  // other metadata
};
          ...
          <div className="bg-white sm:mx-20 mx-28 2xsm:mx-10 3xsm:mx-4 4xsm:mx-6 mt-36 2xsm:mt-6 3xsm:mt-6 4xsm:mt-6  rounded-md">
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <div className="mt-8 mb-8">
                <p>We have sent a verification email to <span className="font-bold text-black">john.smith@example.com.</span> Please check your email for further instructions.</p>
              </div>
              <form>
                <div className="mb-16">
                  <input
