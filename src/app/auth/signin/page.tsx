...
export const metadata: Metadata = {
  title: "Closed Gate Communities | Sign In",
  description: "Closed Gate Communities Sign In Page",
  // other metadata
};
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <form>
                ...
                <div className="flex items-center mb-5">
                  <label htmlFor="default-checkbox" className="text-base font-semibold text-gray-900 dark:text-gray-300">Forget Password?</label>
                </div>
                <div className="mb-5">
                  <input
                    type="submit"
