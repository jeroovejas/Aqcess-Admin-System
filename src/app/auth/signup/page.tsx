...
export const metadata: Metadata = {
  title: "Closed Gate Communities | Sign Up",
  description: "Closed Gate Communities Sign Up Page",
  // other metadata
};
...
const SignUp: React.FC = () => {
  return (
    ...
    <div className="rounded-sm  bg-[url('/images/Authentication/background.jpg')] bg-center bg-no-repeat ">
      <div className="flex flex-wrap py-[61px]">
        ...
        <div className="w-full xl:w-1/2">
          <div className="bg-white md:mt-5 sm:mx-20 mx-28 2xsm:mx-10 3xsm:mx-4 4xsm:mx-6 rounded-md">
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <div className="mb-4  ">
                <p>
                  ...
                  <Link href="/auth/signin" className="text-[#475467] font-bold">
                    Sign in
                  </Link>
                </p>
              </div>
              ...
              <form>
                ...
                <p className="mb-4 block font-medium text-gray-700 dark:text-white">
                ...
                <div className="flex items-center mb-4">
                  <input id="default-checkbox" type="checkbox" value="" className="w-4 h-4 text-blue-600 bg-gray-100 border-gray-300 rounded outline-none  dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" />
                  <label htmlFor="default-checkbox" className="ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">I agree with Terms & conditions</label>
                </div>
