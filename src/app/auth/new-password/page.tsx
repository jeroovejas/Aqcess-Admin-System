...
export const metadata: Metadata = {
  title: "Closed Gate Communities | New Password",
  description: "Closed Gate Communities New Password Page",
  // other metadata
};
          ...
          <div className="bg-white sm:mx-20 mx-28 2xsm:mx-10 3xsm:mx-4 4xsm:mx-6 mt-16 rounded-md">
            ...
            <div className="w-full p-4 sm:p-12.5 xl:p-17.5">
              ...
              <div className="mt-4 mb-6">
                <p>Welcome back! Let's secure your account by setting up a new password.</p>
              </div>
              <div className="mb-4">
