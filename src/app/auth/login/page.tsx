            ...
            <div className="w-full p-12 md:p-17.5">
              ...
              <form onSubmit={handleSubmit}>
                ...
                <div className="flex items-center mb-5">
                  <Link href={"/auth/forgot-password"} className="text-base font-semibold text-gray-900 dark:text-gray-300">Forget Password?</Link>
                </div>
                <div className="mb-5">
                  <button
                    type="submit"
                  ...
                  >
                    {loading ? <AiOutlineLoading3Quarters className="animate-spin mr-2" /> : "Sign in"}
                  </button>
                </div>
